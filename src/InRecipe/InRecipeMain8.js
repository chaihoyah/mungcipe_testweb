...
function InRecipeMain8({history, match, location}) {
  ...
  const ingred = '{ "단호박": "400 (g)", "닭가슴살": "200 (g)", "미숫가루": "160 (mL) / 20 (mL)", "브로콜리": "1 (조각)", "크랜베리": "10 (g)", "현미식초": "10 (g)" }';
  const equip = ["에어프라이기"];
  ...
  const steps_ingred =
            <div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    ...
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/1.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>1. 단호박 씨를 제거하고 15분간 쪄줍니다.</div>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>(※ 젓가락이 들어가면 잘 익은 상태이다.)</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 2</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/2.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>2. 닭가슴살을 식초물에 20분간 소독해준 뒤, 5mm정도의 두꼐로 저며 에어프라이기에 구워줍니다.</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 3</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/3.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>3. 익은 단호박의 속을 긁어내고 5분의1 정도를 데코용으로 남겨 놓는 뒤, 나머지를 으깨 줍니다.</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 4</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/4.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>4. 으깬 단호박에 미숫가루(160mL)를 넣고 뭉쳐질 정도로 반죽합니다.</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 5</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/5.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>5. 반죽을 1cm두께로 밀어주고 동그랗게 만들어줍니다.</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 6</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/6.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>6. 구워진 닭가슴살을 손으로 찢고 남겨놓은 단호박을 조금씩 섞어줍니다.</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 7</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/7.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>7. 섞은 재료를, 만들어 놓은 도우 위에 얹어줍니다.</div>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>(※ 가장자리를 조금 남겨둡니다.)</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 8</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/8.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>8. 데코용 단호박을 미숫가루 20mL와 뭉쳐 반죽을 만든 뒤, 손으로 길게 말아 가장자리에 띠 형태로 붙여줍니다.</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '10vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '5vw', fontFamily: 'AppleNeoB'}}>STEP 9</div>
                    <br></br>
                    <img style= {{width: '100vw'}} src={require("../image/InRecipe8/9.jpg").default}/>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '4.53vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>{"9. '크랜베리'와 '끓는 물에 40초간 데친 브로콜리'를 잘게 썰어 피자 위에 얹어준 뒤, 8등분으로 먹기 좋게 잘라줍니다."}</div>
                </div>
                <div style = {{display: 'flex', flexDirection: 'column', width: '100vw', alignItems: 'center', marginTop: '7vw', marginBottom: '5vw'}}>
                    <div style = {{display: 'flex', flexDirection: 'column', width: '90%', marginTop: '2vw', fontSize: '3vw', fontFamily: 'AppleNeoL', color: 'rgb(85,85,85)'}}>{"레시피 출처: https://www.youtube.com/watch?v=ngPBjsBJhhM"}</div>
                </div>
            </div>
            ...
            <div className="RealRecipe" style = {{overflowX: 'hidden'}}>
                    ...
                    <Navbar fixed='top' style={{display:'flex', flexDirection: 'row', width:'100vw', height: vhTovw(10.86), backgroundColor: 'rgba(0,0,0,0)', justifyContent: 'center', alignItems: 'flex-end'}}>
                        <div style={{display:'flex', flexDirection: 'row', width:'86.10vw', backgroundColor: 'rgba(0,0,0,0)', justifyContent: 'space-between'}}>
                            {!isQR && <Button style={{backgroundColor: 'rgba(0,0,0,0)', border: 'none', outline: 'none'}} onClick={goBack}>
                                <img style = {{height: vhTovw(4.86)}} src= {require('../image/InRecipe8/Asset 69.png').default}/>
                            </Button>}
                            {!isQR && <Button style={{backgroundColor: 'rgba(0,0,0,0)', border: 'none', outline: '#F7F7F7'}} onClick={() => {history.push({pathname: '/inrecipe/order', state:{id: id, addr: addr, phoneNum: phoneNum, recipeKey: 8}})}}>
                ...
                <div className="Recipeimage" style={{position: 'relative', display:'flex', width:'100vw', flexDirection:'column',alignItems:'center'}}>
                    <div className= "Recipeimage" style={{display:'flex', width:'100vw', flexDirection:'column',alignItems:'center'}}>
                        <img style = {{width: '100vw'}} src= {require('../image/InRecipe8/main.jpg').default}/>
                    </div>
                    <div className= "Recipetextbox" style={{position: 'absolute', display:'flex', width:'100vw', flexDirection:'column',alignItems:'center',marginTop: '85vw'}}>
                        <img style = {{width: '96.58vw'}} src= {require('../image/InRecipe8/Asset 72.png').default}/>
                    </div>
                    <div className= "Recipetext" style={{position: 'absolute', display:'flex', width:'75vw', height: '42.48vw',flexDirection:'row',alignItems:'center', justifyContent: 'space-between',marginTop: '82vw', backgroundColor: 'rgba(0,0,0,0)'}}>
                        <div style = {{display: 'flex', flexDirection: 'column', height: '18vw', justifyContent: 'space-between'}}>
                            <div style={{display: 'flex', flexDirection: 'column', fontFamily: 'AppleNeoM', fontSize: '6.15vw', color: 'rgba(85,85,85)'}}>피자</div>
                            <div style={{fontFamily: 'AppleNeoL', fontSize: '3.33vw', color: 'rgba(85,85,85)'}}>{"Puppy\'s Pizza"}</div>
                            <div style={{marginTop: '3vw',fontFamily: 'AppleNeoL', fontSize: '3.33vw', color: 'rgba(85,85,85, 0.5)'}}>몸에 좋고 맛있는 강아지용 피자 간식!</div>
                        </div>
                        <div style = {{display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                            <img style = {{height: '14.02vw'}} src= {require('../image/InRecipe8/Asset 156.png').default}/>
                        </div>
                    </div>
                </div>
